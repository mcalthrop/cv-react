export class DataTransformation {
    ...
    static transformCv(rawData) {
        ...
        const workHistory = DataTransformation.transformWorkHistory(fields.workHistory);
        const education = DataTransformation.transformEducation(fields.education);
        const otherInterests = DataTransformation.transformInterests(fields.interests);
